...
![alt text](IMMerge_workflow.jpg)
  ...
  3. Create a list of vcf files that remain only genotypes and a list of .info.gz files for the corresponding vcf files generated from step 2.
  ...
  5. Split vcf file and .info.gz according to pre-calculated chunks (generated from step 2). [bcftools_chunk_infos.sh](scripts/bcftools_chunk_infos.sh) [split_info_by_region.py](scripts/split_info_by_region.py) <br>
     \# note: split_info_by_region.py was used in bcftools_chunk_infos.sh.
